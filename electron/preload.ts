...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  crm: {
    ...
    getScriptRules: (params: any) => ipcRenderer.invoke('crm:getScriptRules', params),
    saveScriptRules: (params: any) => ipcRenderer.invoke('crm:saveScriptRules', params),
    getScriptExperiment: (params: any) => ipcRenderer.invoke('crm:getScriptExperiment', params),
    saveScriptExperiment: (params: any) => ipcRenderer.invoke('crm:saveScriptExperiment', params),
    ...
    getClientPool: (params: any) => ipcRenderer.invoke('crm:getClientPool', params),
    saveClientPool: (params: any) => ipcRenderer.invoke('crm:saveClientPool', params),
    setClientStage: (params: any) => ipcRenderer.invoke('crm:setClientStage', params),
    removeClientPool: (params: any) => ipcRenderer.invoke('crm:removeClientPool', params),
    getClientPoolStats: (params: any) => ipcRenderer.invoke('crm:getClientPoolStats', params),
  },
  ...
  analytics: {
    ...
    campaignVariantReport: (params: any) => ipcRenderer.invoke('analytics:campaignVariantReport', params),
  ...
  ai: {
    ...
    suggest:         (assistantId: string, chatHistory: any[], zaloId?: string) => ipcRenderer.invoke('ai:suggest', { assistantId, chatHistory, zaloId }),
    chat:            (assistantId: string, messages: any[], structured?: boolean, maxTokens?: number, zaloId?: string) => ipcRenderer.invoke('ai:chat', { assistantId, messages, structured, maxTokens, zaloId }),
  ...
  proxy: {
    ...
    reconnectAccount: (zaloId: string) => ipcRenderer.invoke('proxy:reconnectAccount', { zaloId }),
