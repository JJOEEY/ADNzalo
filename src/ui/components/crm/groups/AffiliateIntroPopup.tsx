      ...
      >
        ...
        <div className="relative bg-gradient-to-br from-amber-600 via-orange-600 to-red-600 px-6 py-8 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-xl font-bold text-white-important mb-1">Kiếm tiền cùng ADNzalo</h2>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
          ...
          <div className="text-center">
            <p className="text-gray-300 text-sm leading-relaxed">
              Bạn đang sử dụng ADNzalo và thấy hữu ích? <span className="text-white font-semibold">Giới thiệu cho bạn bè</span> — mỗi khách hàng mới đăng ký qua mã của bạn, bạn nhận <span className="text-amber-400 font-bold">25% hoa hồng</span> trên giá trị đơn hàng.
            </p>
          </div>

          {/* ── Use cases ─────────────────────────────────────────────── */}
          <div className="space-y-3">
            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider">ADNzalo giúp gì cho người dùng?</h3>
        ...
        <div className="px-6 py-4 border-t border-gray-700 flex flex-col items-center gap-3">
          <button
            onClick={() => ipc.shell?.openExternal('https://adncapital.com.vn/affiliate')}
