...
export const NODE_GROUPS: NodeGroup[] = [
  {
    ...
    items: [
      ...
      { type: 'trigger.customerInactive', label: 'Khách im lặng N ngày', desc: 'Tự động kích hoạt cho từng liên hệ không tương tác quá N ngày — chăm sóc lại, warm-up', channel: CHANNEL.ZALO },
...
export const DEFAULT_CONFIGS: Record<string, Record<string, any>> = {
  ...
  'trigger.customerInactive': { daysSilent: 30, cronExpression: '0 8 * * *', timezone: 'Asia/Ho_Chi_Minh', labelIds: [], maxPerRun: 50 },
  'trigger.manual':        {},
  ...
  'notify.discord':  { webhookUrl: '', message: '', username: 'ADN Bot' },
