 ...
 *
 * API endpoints:
 *   POST https://adncapital.com.vn/api/scan/premium-status  → kiểm tra premium
 *   POST https://adncapital.com.vn/api/scan/group            → quét thành viên nhóm
 *   POST https://adncapital.com.vn/api/payment/create-qr     → tạo QR thanh toán
 *   POST https://adncapital.com.vn/api/payment/check-status  → kiểm tra trạng thái TT
 *   POST https://adncapital.com.vn/api/shared-groups/submit   → chia sẻ nhóm
