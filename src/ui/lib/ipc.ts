  ...
  interface Window {
    electronAPI: {
      ...
      ai: {
        ...
        suggest:         (assistantId: string, chatHistory: any[], zaloId?: string) => Promise<{ success: boolean; suggestions: string[]; error?: string }>;
        chat:            (assistantId: string, messages: any[], structured?: boolean, maxTokens?: number, zaloId?: string) => Promise<{ success: boolean; result?: string; totalTokens?: number; promptTokens?: number; completionTokens?: number; error?: string }>;
