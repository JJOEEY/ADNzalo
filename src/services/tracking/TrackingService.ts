/**
 * TrackingService - Gửi dữ liệu tracking page lên API adncapital.com.vn.
 *
 ...
 *
 * API: POST https://adncapital.com.vn/api/tracking/page
...
const API_URL = 'https://adncapital.com.vn/api/tracking/page';
