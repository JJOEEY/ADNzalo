...
const GITHUB_RELEASES_URL = 'https://github.com/JJOEEY/ADNzalo/releases';
...
const heroScenarios = [
	{
		...
		trigger: 'Khách hỏi thông tin hoặc để lại nhu cầu trong hội thoại',
		logic: 'AI phân loại nhu cầu theo nội dung chat và kho kiến thức đã nạp',
		action: 'Gợi ý phản hồi phù hợp, gắn nhãn và tạo bước follow-up',
		outcome: 'Tư vấn nhất quán và theo sát khách mà không bỏ lỡ bước tiếp theo.',
		steps: [
			{ icon: '💬', label: 'Khách nhắn Zalo', group: 'Trigger' },
			{ icon: '🤖', label: 'AI hiểu nhu cầu', group: 'AI' },
			{ icon: '🧠', label: 'Đối chiếu kho kiến thức', group: 'AI' },
			{ icon: '🏷️', label: 'Gắn nhãn + follow-up', group: 'Action' },
		],
			icon: '💬',
			badge: 'Tư vấn',
