const steps = [
  {
    ...
    title: 'Tải & Cài Đặt',
    desc: 'Tải file cài đặt ADNZalo. Chạy installer và cài đặt trong vài giây. Không cần kỹ thuật phức tạp.',
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-12 text-center aos-element">
          <p className="text-slate-500 text-sm">
            Gặp vấn đề? Liên hệ hỗ trợ qua Zalo hoặc Telegram - đội ngũ sẽ phản hồi bạn sớm nhất.
          </p>
        </div>
      </div>
    </section>
