...
const features: Feature[] = [
  ...
  },
  {
    ...
    useCases: [
      { label: 'Shop online', detail: 'AI gợi ý phản hồi theo nội dung hội thoại và kho kiến thức đã nạp.' },
  ...
  },
  {
    ...
    useCases: [
      ...
      { label: 'Chăm sóc lead', detail: 'Khách im lặng → kiểm tra điều kiện → nhắc nhân viên follow-up và lưu log.' },
    ],
    dark: true,
  },
  {
    ...
    desc: 'Kết hợp workflow với Google Sheets, Telegram, email, Notion và các API bên ngoài.',
    badges: ['Google Sheets', 'HTTP API', 'Webhook'],
    useCases: [
      { label: 'Bảng tính', detail: 'Đọc, ghi hoặc cập nhật dữ liệu Google Sheets từ workflow.' },
      { label: 'Thông báo', detail: 'Gửi thông tin đến Telegram, Discord, email hoặc Notion.' },
      { label: 'Webhook', detail: 'Nhận dữ liệu từ dịch vụ bên ngoài để kích hoạt workflow.' },
      { label: 'API', detail: 'Gửi HTTP request đến hệ thống khác theo điều kiện của workflow.' },
    ],
  },
  {
    id: 'analytics',
